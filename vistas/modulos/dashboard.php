...
echo "<script type='text/javascript'>localStorage.setItem('sucursal','".$sucursal."');</script>";
    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pillTablero" role="tabpanel" >
            <div class="container-fluid" id="contentGr">
                ...
                <div class="row" id="contenedorGeneralSemaforos"><!-- Contenedor para los semaforos -->
                    ...
                    <div class="col-md-2 col-lg-2 col-xlg-2" style="margin-left: ">
                        <div class="card card-hover">
                ...
                </div> <!-- Fin del contenedor de los Semaforos -->

                <div class="row" id="cuadrosData"><!-- Contenedor de los cuados de datos (Superior) -->
                ...
                </div><!-- Fin del contenedor de Cuadros de datos (Superior) -->

                <div class="row" id="cuadrosData2"><!-- Contenedor de los cuados de datos (Inferior) -->
                ...
                </div><!-- Fin del contenedor de Cuadros de datos (Inferor) -->
